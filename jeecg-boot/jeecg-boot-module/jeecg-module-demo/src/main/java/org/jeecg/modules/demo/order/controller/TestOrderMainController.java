...
public class TestOrderMainController {
	...
	@Operation(summary="测试订单主表-分页列表查询")
	...
	public Result<IPage<TestOrderMain>> queryPageList(TestOrderMain testOrderMain,
        ...
        customeRuleMap.put("xiala", QueryRuleEnum.LIKE_WITH_OR);
        QueryWrapper<TestOrderMain> queryWrapper = QueryGenerator.initQueryWrapper(testOrderMain, req.getParameterMap(),customeRuleMap);
	...
	@Operation(summary="测试订单主表-添加")
    @RequiresPermissions("order:test_order_main:add")
	...
	@Operation(summary="测试订单主表-编辑")
    @RequiresPermissions("order:test_order_main:edit")
	...
	@Operation(summary="测试订单主表-通过id删除")
    @RequiresPermissions("order:test_order_main:delete")
	...
	@Operation(summary="测试订单主表-批量删除")
    @RequiresPermissions("order:test_order_main:deleteBatch")
	...
	@Operation(summary="测试订单主表-通过id查询")
	...
	@Operation(summary="订单产品明细主表ID查询")
    ...
    * @param testOrderMain
    */
    @RequiresPermissions("order:test_order_main:exportXls")
    ...
    public ModelAndView exportXls(HttpServletRequest request, TestOrderMain testOrderMain) {
      ...
      mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("测试订单主表数据", "导出人:"+sysUser.getRealname(), "测试订单主表", ExcelType.XSSF));
    ...
    * @return
    */
    @RequiresPermissions("order:test_order_main:importExcel")
